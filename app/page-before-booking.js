    ...
    <main className="min-h-screen bg-white text-slate-900">
      <nav className="sticky top-0 z-50 bg-white/95 shadow-sm backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
          ...
          <a
            href="#book"
            className="rounded-full bg-pink-500 px-5 py-3 text-sm font-bold text-white"
          >
            Book Ride
          </a>
        </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-2 md:items-center">
          <div>
            <p className="mb-5 inline-block rounded-full bg-pink-500/20 px-4 py-2 text-sm font-bold text-pink-200">
              SUV Medical Transportation Now Available
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <a href="tel:+10000000000" className="rounded-full bg-white px-8 py-4 text-center font-bold text-[#0A2342]">
                Call Now
              </a>
            </div>
          </div>
      ...
      <section className="bg-slate-50 px-5 py-20">
        <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-2 md:items-center">
          <div>
            <p className="font-bold text-pink-500">Why Choose Care Cruise</p>
            <h2 className="mt-3 text-4xl font-black text-[#0A2342]">
              Professional, compassionate, and built for trust.
            </h2>
          </div>

          <div className="grid gap-4">
            {[
              "Clean and comfortable SUV transportation",
              "Friendly support for seniors and families",
              "Reliable scheduling for medical appointments",
              "Private-pay service with premium care standards",
            ].map((item) => (
      ...
      <section id="book" className="bg-gradient-to-br from-pink-500 to-[#0A2342] px-5 py-20">
        <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-2">
          ...
          <form className="grid gap-4 rounded-3xl bg-white p-6 shadow-2xl">
            ...
            <input className="rounded-xl border p-3" placeholder="Pickup Address" />
            <input className="rounded-xl border p-3" placeholder="Destination Address" />
            <input className="rounded-xl border p-3" type="date" />
            <input className="rounded-xl border p-3" type="time" />
            <textarea className="rounded-xl border p-3" placeholder="Special Notes" rows="4" />
      ...
      <footer className="bg-slate-950 px-5 py-12 text-white">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-2 text-slate-300">Phone: Coming Soon</p>
            <p className="text-slate-300">Email: Coming Soon</p>
          </div>
          <div>
